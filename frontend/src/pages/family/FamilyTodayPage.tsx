...
export function FamilyTodayPage() {
  ...
  const caregiver = resident.currentCaregiverId
    ...
    : undefined;
  // Live CareEvents the caregiver registers this session are merged into
  // Carmen's timeline here, in chronological order alongside the
  // pre-scripted "story of the day" -- see state/careEventsState.tsx.
  const timelineEvents = useResidentTimeline(resident.id);
